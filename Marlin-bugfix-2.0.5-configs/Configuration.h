...
#define STRING_CONFIG_H_AUTHOR "xnopasaranx" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mausbot Printer"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Mausbot E3d V6
  #define DEFAULT_Kp 4.89
  #define DEFAULT_Ki 0.47
  #define DEFAULT_Kd 12.76
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 20, 500 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 15, -1.55 }
...
#define Y_MIN_POS -22
#define Z_MIN_POS 0
#define X_MAX_POS 310 // 15mm Extra space on the right end
#define Y_MAX_POS 310 // 4mm Extra space behind the bed
...
#define HOMING_FEEDRATE_Z  (3*60) // was (4*60)
